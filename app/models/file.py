...
class FileMetadata(BaseModel):
    ...
    tags: str | None = Field(None, description="File tags (JSON string)")
    uploader_ip: str | None = Field(None, description="Uploader IP address")
...
class SystemInfoResponse(BaseModel):
    ...
    total_files: int | None = Field(None, description="Total files stored")
    total_size: int | None = Field(None, description="Total storage used")
